...
const sectionsTr = [
  ...
  { title: "Hesap güvenliği ve kayıt bilgileri", body: (
    <>
      ...
      {bulletList([
        ...
        "Hesabınızda yetkisiz erişim fark ettiğinizde derhâl bizimle iletişime geçmek (info@cv-with-ai.com)",
  ...
  { title: "İptal ve iade", body: (
    <>
      ...
      <p className="mt-3">
        ...
        haksız tahsilatlar talep üzerine iade edilir. İade taleplerinizi info@cv-with-ai.com adresine
        iletebilirsiniz.
      </p>
    </>
  )},
  ...
  { title: "Uyuşmazlık çözümü ve tahkim", body: (
    <>
      ...
      <p className="mt-3">
        ...
        talep iletmek isterseniz, önce info@cv-with-ai.com adresine yazılı bildirim göndererek meseleyi 60 gün
      ...
      <p className="mt-3">
        ...
        hükümlerine bağlı kalmamayı tercih edebilirsiniz. Vazgeçme bildirimi info@cv-with-ai.com adresine
        gönderilmelidir.
      </p>
      <p className="mt-3">
  ...
  { title: "İletişim", body: (
    <p>
      ...
      bizimle <em className="not-italic font-semibold text-saffron">info@cv-with-ai.com</em> adresinden
...
const sectionsEn = [
  ...
  { title: "Account security and registration", body: (
    <>
      ...
      {bulletList([
        ...
        "Notify us immediately of any unauthorized access at info@cv-with-ai.com",
  ...
  { title: "Cancellations and refunds", body: (
    <>
      ...
      <p className="mt-3">
        ...
        Contact info@cv-with-ai.com for refund inquiries.
      </p>
    </>
  )},
  ...
  { title: "Dispute resolution and arbitration", body: (
    <>
      ...
      <p className="mt-3">
        ...
        info@cv-with-ai.com and to attempt to resolve the matter in good faith over a 60-day period. This
      ...
      <p className="mt-3">
        ...
        arbitration and class-action waiver by sending written notice to info@cv-with-ai.com within 30 days of
  ...
  { title: "Contact", body: (
    <p>
      ...
      <em className="not-italic font-semibold text-saffron">info@cv-with-ai.com</em>. To request a copy of a
