...
const sectionsTr = [
  ...
  { title: "İletişim", body: (
    <p>
      ...
      bizimle <em className="not-italic font-semibold text-saffron">info@cv-with-ai.com</em> adresinden iletişime geçebilirsiniz.
    </p>
  )},
];
...
const sectionsEn = [
  ...
  { title: "Contact", body: (
    <p>
      ...
      at <em className="not-italic font-semibold text-saffron">info@cv-with-ai.com</em>.
    </p>
  )},
];
