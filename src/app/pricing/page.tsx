...
const copy = {
  en: {
    ...
    ctaSub: "A typeset press for résumés and cover letters — free to try, no card required.",
  ...
  tr: {
    ...
    ctaSub: "Özgeçmiş ve ön yazılar için dizilmiş bir matbaa — ücretsiz başlayın, kart gerekmez.",
      ...
      <footer className="border-t-2 border-ink-deep bg-paper py-10 noise-paper">
        <div className="mx-auto flex max-w-[1400px] flex-col items-center gap-4 px-6 font-serif text-xs italic text-ink-soft md:flex-row md:justify-between md:px-12">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a className="hover:text-saffron" href="mailto:support@cv-with-ai.com">{l === "tr" ? "İletişim" : "Contact"}</a>
          </div>
        </div>
      </footer>
    </main>
