...
const translations = {
  ...
  "dashboard.subtitle": { en: "Your executive workspace for high-impact resumes and strategic career documents.", tr: "Etkili CV'ler ve stratejik kariyer belgeleri için profesyonel çalışma alanınız." },
  ...
  "dashboard.upgradeDesc": { en: "Upgrade to Pro for unlimited resumes, cover letters, and AI-powered features.", tr: "Sınırsız CV, ön yazı ve yapay zekâ destekli özellikler için Pro'ya yükseltin." },
  "dashboard.newDoc": { en: "New Professional Document", tr: "Yeni Profesyonel Belge" },
  "dashboard.newDocDesc": { en: "Draft a results-driven resume from scratch or use AI-powered optimization to refine your expertise for the market.", tr: "Sıfırdan sonuç odaklı bir CV hazırlayın veya yapay zekâ destekli optimizasyonla deneyiminizi piyasaya uygun hâle getirin." },
  ...
  "dashboard.startDesc": { en: "Begin by creating a new professional resume or selecting a high-fidelity template.", tr: "Yeni bir profesyonel CV hazırlayarak ya da yüksek kaliteli bir şablon seçerek başlayın." },
  ...
  "resume.autosave": { en: "Autosaves locally and syncs to your account when signed in.", tr: "Yerelde otomatik kaydedilir; giriş yaptığınızda hesabınızla senkronize olur." },
  "resume.aiOptimize": { en: "AI-Powered Optimization", tr: "Yapay Zekâ Optimizasyonu" },
  "resume.upgradeAi": { en: "Upgrade for AI Features", tr: "Yapay Zekâ İçin Yükselt" },
  ...
  "resume.aiRefineSummary": { en: "AI-Refine Summary", tr: "Yapay Zekâ ile İyileştir" },
  ...
  "resume.aiRefineAchievement": { en: "AI-Refine Achievement", tr: "Yapay Zekâ ile İyileştir" },
  ...
  "coverLetter.subtitle": { en: "Choose a professionally designed layout. AI fills it with your resume data — ready to send in seconds.", tr: "Profesyonelce tasarlanmış bir düzen seçin. Yapay zekâ, CV verilerinizle doldurur — saniyeler içinde göndermeye hazır." },
  "coverLetter.aiPowered": { en: "AI-powered.", tr: "Yapay zekâ destekli." },
  "coverLetter.aiDesc": { en: "Pulls from your saved resume automatically.", tr: "Kayıtlı CV'nizden bilgileri otomatik olarak çeker." },
  "coverLetter.aiUpgradeDesc": { en: "Upgrade to Pro to generate cover letters with AI.", tr: "Yapay zekâ ile ön yazı oluşturmak için Pro'ya yükseltin." },
  "coverLetter.useTemplate": { en: "Use Template", tr: "Şablonu Kullan" },
  "coverLetter.proFeature": { en: "Pro Feature", tr: "Pro Özelliği" },
  "coverLetter.proDesc": { en: "AI-powered cover letter generation is available for Pro users. Upgrade to create personalized cover letters from your resume data.", tr: "Yapay zekâ destekli ön yazı oluşturma Pro kullanıcılara özeldir. CV verilerinizden kişiselleştirilmiş ön yazılar hazırlamak için Pro'ya yükseltin." },
  ...
  "gate.signInResumeDesc": { en: "Create an account or sign in to start building your professional resume with our AI-powered tools.", tr: "Yapay zekâ destekli araçlarımızla profesyonel CV'nizi hazırlamaya başlamak için hesap oluşturun ya da giriş yapın." },
  "gate.signInCover": { en: "Sign in to create cover letters", tr: "Ön yazı oluşturmak için giriş yapın" },
  "gate.signInCoverDesc": { en: "Create an account or sign in to generate professional cover letters with AI.", tr: "Yapay zekâ ile profesyonel ön yazılar oluşturmak için hesap oluşturun ya da giriş yapın." },
  "gate.signInDashboard": { en: "Sign in to your dashboard", tr: "Kontrol panelinize giriş yapın" },
  "gate.signInDashboardDesc": { en: "Create an account or sign in to access your resume workspace and manage your documents.", tr: "CV çalışma alanınıza erişmek ve belgelerinizi yönetmek için hesap oluşturun ya da giriş yapın." },
  "gate.signInTemplates": { en: "Sign in to browse templates", tr: "Şablonlara göz atmak için giriş yapın" },
  "gate.signInTemplatesDesc": { en: "Create an account or sign in to choose from 100 professionally designed resume templates.", tr: "Profesyonelce tasarlanmış 100 CV şablonu arasından seçim yapmak için hesap oluşturun ya da giriş yapın." },
  "gate.freeTrialUsed": { en: "You've used your free resume. Sign in or create an account to continue building resumes.", tr: "Ücretsiz CV hakkınızı kullandınız. CV hazırlamaya devam etmek için giriş yapın veya hesap oluşturun." },
  ...
  "gate.upgradeResumeDesc": { en: "You've used your free resume. Upgrade to Pro to create unlimited resumes with AI-powered optimization.", tr: "Ücretsiz CV hakkınızı kullandınız. Yapay zekâ destekli optimizasyonla sınırsız CV oluşturmak için Pro'ya yükseltin." },
  ...
  "ai.helper": { en: "AI Helper", tr: "Yapay Zekâ Yardımcısı" },
  ...
  "step.import.tip": { en: "AI extracts your name, history, skills, and education in a few seconds — saves 20+ minutes of typing.", tr: "Yapay zekâ; adınızı, geçmişinizi, yetkinliklerinizi ve eğitiminizi saniyeler içinde çıkarır — 20+ dakika kazandırır." },
  ...
  "step.summary.desc": { en: "A tight summary tells recruiters in 5 seconds why you fit. AI can polish it.", tr: "Özlü bir özet, işe alım uzmanlarına 5 saniyede neden uygun olduğunuzu anlatır. Yapay zekâ son rötuşları yapabilir." },
  "step.summary.tip": { en: "Lead with your strongest result (\"Shipped X to Y users\") — vague summaries get skimmed.", tr: "En güçlü sonucunuzla başlayın (\"X'i Y kullanıcıya ulaştırdım\") — belirsiz özetler hızla geçilir." },
  ...
  "step.skills.tip": { en: "Mix hard skills (tools, frameworks) with role-specific soft skills. Skip the generic ones like \"teamwork.\"", tr: "Teknik becerileri (araç, framework) role özgü kişisel becerilerle birleştirin. \"Takım çalışması\" gibi genel ifadelerden kaçının." },
  ...
  "step.certificates": { en: "Certificates", tr: "Sertifikalar" },
  "step.certificates.title": { en: "Certificates & credentials", tr: "Sertifikalar ve belgeler" },
  "step.certificates.desc": { en: "Professional certifications, courses, and credentials — add the ones that reinforce the role you're targeting.", tr: "Hedeflediğiniz role değer katan profesyonel sertifikalar, kurslar ve belgeleri ekleyin." },
  "step.certificates.tip": { en: "Include issuer and dates so recruiters can verify quickly. Drop the credential link if there's a public verification page.", tr: "İşe alımcıların hızlıca doğrulayabilmesi için kuruluş adını ve tarihleri ekleyin. Varsa doğrulama bağlantısını da bırakın." },
  "resume.certificates": { en: "Certificates", tr: "Sertifikalar" },
  "resume.addCertificate": { en: "Add Certificate", tr: "Sertifika Ekle" },
  "resume.certName": { en: "Certificate Name", tr: "Sertifika Adı" },
  "resume.certIssuer": { en: "Issuing Organization", tr: "Veren Kuruluş" },
  "resume.certIssueDate": { en: "Issue Date", tr: "Veriliş Tarihi" },
  "resume.certExpiryDate": { en: "Expiry Date", tr: "Geçerlilik Sonu" },
  "resume.certCredentialUrl": { en: "Credential URL", tr: "Doğrulama Bağlantısı" },
  "resume.certNoExpiry": { en: "Does not expire", tr: "Süresiz" },
  ...
  "step.review.tip": { en: "Run \"Audit Resume\" for an AI-powered score with strengths, gaps, and recommendations.", tr: "Yapay zekâ destekli puan, güçlü yönler ve eksiklikler için \"CV'yi Analiz Et\"i çalıştırın." },
  "step.review.complete": { en: "Complete", tr: "Tamamlandı" },
  "step.review.incomplete": { en: "Needs attention", tr: "Eksik" },
  ...
  "step.review.finishFirst": { en: "Finish remaining sections for the strongest result.", tr: "En güçlü sonuç için kalan bölümleri tamamlayın." },
} as const;
