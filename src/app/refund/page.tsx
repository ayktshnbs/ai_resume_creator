...
const sectionsTr = [
  ...
  { title: "Teknik sorunlar", body: (
    <p>
      ...
      durumu <em className="not-italic font-semibold text-saffron">info@cv-with-ai.com</em> adresine bildirmeniz
  ...
  { title: "İletişim", body: (
    <p>
      ...
      <em className="not-italic font-semibold text-saffron"> info@cv-with-ai.com</em> adresinden bizimle iletişime geçebilirsiniz.
    </p>
  )},
];
...
const sectionsEn = [
  ...
  { title: "Technical issues", body: (
    <p>
      ...
      at <em className="not-italic font-semibold text-saffron">info@cv-with-ai.com</em> and the issue will be
  ...
  { title: "Contact", body: (
    <p>
      ...
      <em className="not-italic font-semibold text-saffron"> info@cv-with-ai.com</em>.
    </p>
  )},
];
